...
- After every run — pass or fail — write your results to the Delta section of `coordination.md` in your project memory directory, labeled with the round number. Do not skip this step if everything passes.
